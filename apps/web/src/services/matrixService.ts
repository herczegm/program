...
export const matrixService = {
  fast(params?: {
    ...
    if (params?.levelCompetencyId) qs.set('levelCompetencyId', params.levelCompetencyId)
    if (params?.minLevel !== undefined) qs.set('minLevel', String(params.minLevel))
    if (params?.exactLevel !== undefined) qs.set('exactLevel', String(params.exactLevel))
